...
const payload = {
  ...
  data: {
    ...
    special: [
      { name: "Con Garantía Hipotecaria", max_months: 130, tea: 21.70, tem: 1.65 },
      { name: "Con Garantía DPF", max_months: 130, description: "Se establece 4.0% adicional a la tasa de interes pasiva del DPF." }
    ],
...
async function run() {
  console.log('Insertando configuración de crédito matrix con PLAZOS...')
